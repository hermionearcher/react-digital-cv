      ...
      <div id="container--main">
        ...
        <section className="section--page">
          ...
          <div id="wrapper--techstack__items">
            <div className="card--techstack"><span>Python, JavaScript, NodeJS</span></div>
            <div className="card--techstack"><span>Django, Express, Flask, FastAPI</span></div>
            <div className="card--techstack"><span>React, Next JS</span></div>
            <div className="card--techstack"><span>Postgres, MongoDB, MySQL</span></div>
          </div>
        </section>
